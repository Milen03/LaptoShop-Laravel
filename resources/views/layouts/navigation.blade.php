        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('laptops.index')" :active="request()->routeIs('laptops.*')">
                        {{ __('Laptops') }}
                    </x-nav-link>

                          <x-nav-link :href="route('laptops.create')" :active="request()->routeIs('laptops.*')">
                        {{ __('Create') }}
                    </x-nav-link>
                </div>
            </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                @guest
                    <div class="flex space-x-4">
                        <a href="{{ route('login') }}"
                           class="text-sm text-gray-700 underline">{{ __('Login') }}</a>
                        <a href="{{ route('register') }}"
                           class="text-sm text-gray-700 underline">{{ __('Register') }}</a>
                    </div>
                @endguest
            </div>
        </div>
